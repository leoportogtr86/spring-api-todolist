...
20. **Endpoint de Busca de Tarefa por ID**: Implemente um endpoint GET para buscar uma tarefa pelo ID. - OK
21. **Endpoint de Atualização de Tarefa**: Implemente um endpoint PUT para atualizar uma tarefa existente. - OK
22. **Endpoint de Exclusão de Tarefa**: Implemente um endpoint DELETE para excluir uma tarefa pelo ID. - OK
23. **Endpoint para Listar Todas as Tarefas**: Implemente um endpoint GET para listar todas as tarefas. - OK
